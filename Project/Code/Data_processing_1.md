...
plt.plot(y[211], color ='salmon',label='DHT temp')
plt.ylabel("RAW Temperature (C)")
plt.xlabel('Time(minutes)')
#Bme Temperature
plt.plot(y[213], color ='cornflowerblue', label='BME temp')
#Average temperature
...
#Bme
temp_smooth = moving_average(windowSize=10, x=y[213])
...
plt.plot(y[212], color ='lightcyan')

hum_smooth = moving_average(windowSize=10, x=y[212])
...
plt.plot(y[214], color ='Thistle')

pres_smooth = moving_average(windowSize=10, x=y[214])
